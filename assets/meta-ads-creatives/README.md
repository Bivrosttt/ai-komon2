...
- `current/json-first-5/`：2026-07-13生成案のうち価格表記のない4案
- `current/meta-ads-basic-4/`：基本訴求のうち価格表記のない3案
- `current/lp-top5-5/`：LPトップ5連動案のうち価格表記のない3案
...
- `archive/price-15-2026-07-17/`：月15万円表記を含む旧価格クリエイティブ10案とコンタクトシート
...
5. `archive/price-15-2026-07-17/` の画像は月15万円表記のため、月50万円〜の期間中は配信に使用しない。
